...
def ctposeseg_decode(heat, wh, kps, seg_feat, conv_weight, reg=None, cat_spec_wh=False, hm_hp=None, hp_offset=None, K=100):
    batch, cat, height, width = heat.size()
...
def ctsegpose_train_decode(heat, wh, kps, cat_spec_wh=False, reg=None,  hm_hp=None, hp_offset=None, K=100):
    batch, cat, height, width = heat.size()
    num_joints = kps.shape[1] // 2
    # heat = torch.sigmoid(heat)
    # perform nms on heatmaps
